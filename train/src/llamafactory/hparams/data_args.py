...
class DataArguments:
    ...
    teacher_feat_dir: Optional[str] = field(
        default=None,
        metadata={"help": "Path to pre-extracted teacher features (.npy), one per image."},
    )
    medsam_mask_root: Optional[str] = field(
        default=None,
        metadata={"help": "Root dir of MedSAM predicted masks (e.g., /root/.../HAM10000/MedSAM_pred)."},
    )
    medsam_mask_ext: str = field(
        default="png",
        metadata={"help": "File extension of MedSAM masks, e.g. png."},
    )
